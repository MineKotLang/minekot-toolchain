...
| Explicit nested scope          | Partial       | Full analysis resolves outer class and object members through nested lambdas without treating explicit safe calls or lambda-receiver DSL members as outer-class access. Some inline-contract and unlabeled-receiver shapes remain unsupported. |
