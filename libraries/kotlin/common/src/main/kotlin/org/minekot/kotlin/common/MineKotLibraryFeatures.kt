...
val mineKotLibraryFeatureDescriptors: List<MineKotLibraryFeatureDescriptor> = listOf(
    ...
    MineKotLibraryFeatureDescriptor(
        ...
        dependencyReason = "Adventure JSON helpers depend on Adventure Gson serializer.",
    ...
    MineKotLibraryFeatureDescriptor(
        module = ":libraries:codegen:minekot-ksp",
        feature = "ksp-symbols",
        publicSymbols = listOf("mineKotAnnotatedClasses", "mineKotTypedArgument", "writeMineKotTo"),
